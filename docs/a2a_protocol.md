...
app:
  ...
  # deploy with: dao-ai agent up --mode apps
  agents:
    - *my_agent
```
...
See `examples/19_a2a_protocol/client/client.py` for a Python script that:
...
And `examples/19_a2a_protocol/a2a_minimal.yaml` for the deploy-
ready agent config.
