...
```bash
dao-ai chat -c examples/15_instructed_retriever/instructed_retriever.yaml
```
...
```bash
dao-ai chat -c examples/15_instructed_retriever/full_pipeline.yaml
```
...
- **99_complete_applications/** - See instructed retrieval in production apps
