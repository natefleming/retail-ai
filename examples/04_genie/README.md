...
dao-ai chat -c examples/04_genie/genie_cached.yaml
...
dao-ai chat -c examples/04_genie/genie_in_memory_context_aware_cache.yaml
...
dao-ai chat -c examples/04_genie/genie_cached.yaml --log-level DEBUG
```
