...
```bash
# SQL tools
dao-ai chat -c examples/14_basic_tools/sql_tool_example.yaml

# REST API tools
dao-ai chat -c examples/14_basic_tools/rest_api_tool.yaml

# Slack integration
dao-ai chat -c examples/14_basic_tools/slack_integration.yaml

# Teams integration
dao-ai chat -c examples/14_basic_tools/teams_integration.yaml
```
