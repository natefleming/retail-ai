...
```bash
# Validate
dao-ai validate -c examples/20_a2a_protocol/a2a_minimal.yaml

# Deploy to Databricks Apps (mounts the A2A endpoints)
dao-ai agent up -c examples/20_a2a_protocol/a2a_minimal.yaml --mode apps
```
...
- Background kickoff/poll/cancel: [`19_background_agents/`](../19_background_agents/)
