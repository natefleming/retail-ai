...
```bash
# Validate patterns
dao-ai validate -c examples/13_orchestration/supervisor_pattern.yaml
dao-ai validate -c examples/13_orchestration/swarm_pattern.yaml
dao-ai validate -c examples/13_orchestration/deep_agent_with_skills.yaml

# Chat with supervisor or deep_agent
dao-ai chat -c examples/13_orchestration/supervisor_pattern.yaml
dao-ai chat -c examples/13_orchestration/deep_agent_pattern.yaml
