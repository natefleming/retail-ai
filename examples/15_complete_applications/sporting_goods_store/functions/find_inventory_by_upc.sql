...
READS SQL DATA
COMMENT 'Retrieves detailed inventory information for specific products by UPC across all stores. The upc parameter is required. For broad inventory queries without specific UPCs, use the Genie analytics tool instead.'
RETURN 
SELECT 
  inventory_id
  ,products.sku
