...
DATABRICKS_CONFIG_PROFILE=DEFAULT uv run dao-ai validate \
  -c examples/99_complete_applications/brick_store/brick_store.yaml
...
- **Lakebase memory + extraction** — `examples/99_complete_applications/hardware_store_lakebase.yaml`
...
- **Commerce Swarm (pipeline sibling)** — `examples/99_complete_applications/commerce/commerce_supervisor.README.md`
