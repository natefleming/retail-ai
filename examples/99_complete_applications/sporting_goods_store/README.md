...
```bash
# Full
uv run dao-ai validate -c examples/99_complete_applications/sporting_goods_store/sporting_goods_store.yaml

# Slim
uv run dao-ai validate -c examples/99_complete_applications/sporting_goods_store/sporting_goods_store_slim.yaml
```

### Chat locally

```bash
uv run dao-ai chat -c examples/99_complete_applications/sporting_goods_store/sporting_goods_store.yaml
```
...
```bash
uv run dao-ai graph \
  -c examples/99_complete_applications/sporting_goods_store/sporting_goods_store.yaml \
...
uv run dao-ai workflow up \
  -c examples/99_complete_applications/sporting_goods_store/sporting_goods_store_slim.yaml \
  -p DEFAULT
```
...
- **Supervisor orchestration** — `examples/99_complete_applications/hardware_store/hardware_store.yaml`
- **Lakebase memory** — `examples/99_complete_applications/hardware_store/hardware_store_lakebase.yaml`
- **Instructed retrieval** — `examples/99_complete_applications/hardware_store/hardware_store_instructed.yaml`
- **Commerce supervisor / swarm (Lakebase + Genie + VS)** — `examples/99_complete_applications/commerce/`
